...
## 7 - Finding Events of Interest with Derivatives and HDBSCAN
How to use some simple NumPy functions to find interesting traces. Using HDBSCAN with MUSIC data.
